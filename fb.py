...
def banner():
	...
	print(cyan('  ',bold=True),green('Author : Fajar Id',bold=True))
	print(cyan('  ',bold=True),green('Contact: my fb Fajar id sampah masyarakat',bold=True))
	print(cyan('  ',bold=True),green('version:',bold=True),cyan('1.6',bold=True))
